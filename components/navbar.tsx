...
import { Search, Menu, Moon, Bell, Sun, BookOpen } from "lucide-react";
        ...
        <div className="flex h-14 md:h-16 items-center justify-between">
          ...
          <div className="hidden md:flex items-center w-full px-4">
            ...
            <div className="flex items-center gap-6 ml-auto">
              {/* Notification */}
              <div className="flex flex-col items-center text-[11px] text-muted-foreground hover:text-foreground cursor-pointer">
