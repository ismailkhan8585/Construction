                    ...
                    {"subItems" in item ? (
                      ...
                      >
                        <DropdownMenuTrigger asChild>
                          <Button
                            variant="ghost"
                            className="flex items-center gap-1 hover:bg-muted w-full justify-center px-2 text-xs md:text-sm text-white"
                            ...
                            <DropdownMenuSub key={subItem.title}>
                              ...
                              <DropdownMenuSubContent className="w-40 md:w-48 ">
                                {subItem.items.map((project) => (
                                  <DropdownMenuItem
                                    key={project}
                                    className="text-xs md:text-sm hover:bg-muted"
                                  >
                                    Project {project}
                                  </DropdownMenuItem>
                                ))}
                            ...
                            <div className="pl-4 space-y-1 ">
                              {("subItems" in item
                                ...
                                .map((subItem) => (
                                  <div
                                    key={subItem}
                                    className="text-sm text-muted-foreground p-1 hover:text-foreground cursor-pointer"
                                  >
                                    {subItem}
                                  </div>
                                ))}
